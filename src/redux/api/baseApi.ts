...
//   ) {
//     api.dispatch(logout());
//     // Do not force a global redirect on 401/403 here —
//     // public pages (like the home page) call some endpoints and
//     // should not be redirected automatically when those calls
//     // return 401/403. Components or route-level guards can handle
